...
export default function InteractiveChicken({ selectedPart, onSelectPart }: InteractiveChickenProps) {
  return (
    <div className="w-full max-w-md mx-auto">
      <h2 className="text-xl font-bold text-center mb-4">部位をタップしてください</h2>
      
      <svg viewBox="0 0 500 300" className="w-full h-auto drop-shadow-xl cursor-pointer interactive-butcher-svg">
        {/* 鶏のシルエット定義 */}
        <g stroke="white" strokeWidth="2">
          ...
          />
          <text x="205" y="120" fill="white" fontSize="14" textAnchor="middle" pointerEvents="none" fontWeight="bold">胸肉</text>
          ...
          />
          <text x="310" y="150" fill="white" fontSize="14" textAnchor="middle" pointerEvents="none" fontWeight="bold">もも</text>
          ...
          />
          <text x="120" y="110" fill="white" fontSize="12" textAnchor="middle" pointerEvents="none" fontWeight="bold">手羽</text>
          ...
          />
          <text x="205" y="170" fill="white" fontSize="12" textAnchor="middle" pointerEvents="none" fontWeight="bold">レバー</text>
